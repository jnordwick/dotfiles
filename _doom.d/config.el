...
(map! :after lsp-mode
      ...
      (:n "c r" nil
       :n "c o" nil
       :n "l r r" #'lsp-rename
       :n "l r o" #'lsp-organize-imports
       :n "l l d" #'lsp-ui-peek-find-definitions
       :n "l l r" #'lsp-ui-peek-find-references
       :n "l g p" #'lsp-find-declaration
       :n "l g d" #'lsp-find-definition
       :n "l g r" #'lsp-find-references))
...
;;
(map! (:leader
       :iv "C-y C-y" #'yas-expand
       :prefix ("y" . "yas snippets")
       :n "n" #'yas-new-snippet
       :n "v" #'yas-visit-snippet-file
       :n "y" #'yas-expand)

      (:mode snippet-mode
       :localleader
       :n "l" #'yas-load-snippet-buffer
       :n "c" #'yas-load-snippet-buffer-and-close
